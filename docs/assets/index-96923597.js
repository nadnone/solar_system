...
`)}function sd(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function _i(i){return i!==""}function Ia(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Na(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ad=/^[ \t]*#include +<([\w\d./]+)>/gm;function as(i){return i.replace(ad,ld)}const od=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function ld(i,e){let t=Le[e];if(t===void 0){const n=od.get(e);if(n!==void 0)t=Le[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return as(t)}const cd=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fa(i){return i.replace(cd,ud)}function ud(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Oa(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function hd(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Za?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Wo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Jt&&(e="SHADOWMAP_TYPE_VSM"),e}function fd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ti:case ni:e="ENVMAP_TYPE_CUBE";break;case ar:e="ENVMAP_TYPE_CUBE_UV";break}return e}function dd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ni:e="ENVMAP_MODE_REFRACTION";break}return e}function pd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ls:e="ENVMAP_BLENDING_MULTIPLY";break;case ul:e="ENVMAP_BLENDING_MIX";break;case hl:e="ENVMAP_BLENDING_ADD";break}return e}function md(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function _d(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=hd(t),c=fd(t),h=dd(t),d=pd(t),f=md(t),m=t.isWebGL2?"":id(t),v=rd(s),g=r.createProgram();let p,u,b=t.glslVersion?"#version "+t.glslVersion+`
...
`,ja=60,Dt=Math.PI/180,Ka=[66900,6e6],Yp=26.7,jp="#00698a",Kp=1,Uo=0,Zr={x:10,y:10,z:15},Zp=1/32,$p=1,Do=1/60;function Io(i,e){let t=[];for(let n=0;n<=360;n+=1)if(i!==4){const r=At[0]+xi[i]+At[i],s=Math.cos(n*Dt)*r*e,o=Math.sin(n*Dt)*r*e,a=Math.cos(n*Dt)*Math.sin(Lo[i]*Dt)*r*e;let l=new P(s,a,o);t.push(l)}return t}function No(i,e,t){let n=[];for(let r=0;r<=360;r+=10){const s=(At[7]+Ka[0]/Ka[1]*i)*e,o=t[7].position,a=o.x+Math.cos(r*Dt)*s,l=o.z+Math.sin(r*Dt)*s,c=o.y+Math.cos(r*Dt)*Math.sin(Yp*Dt)*s;let h=new P(a,c,l);n.push(h)}return n}const Ft=new Xd,mi=new bt(75,window.innerWidth/window.innerHeight,.1,1e3),ms=new Ro;ms.setSize(window.innerWidth,window.innerHeight);document.body.appendChild(ms.domElement);let Mi=document.createElement("div");Mi.className="panel";document.body.appendChild(Mi);let fr=document.createElement("div");fr.className="name_astre";fr.innerText=Po[Uo];document.body.appendChild(fr);let et=Kp,hn=1,sr=!1,rt=Uo,mt=[],Jn=[],Rn=[],gi=new wo(16777215,Co,(xi[9]+At[0])*et);Ft.add(gi);let $r=0;for(let i=0;i<10;i++){const e=new ps(At[i],32,32);let t=new Wa({color:Zn[i],emissive:Zn[i],emissiveIntensity:Zp});i===0&&(t=new Wa({color:Zn[i],emissive:Zn[i],emissiveIntensity:$p}));const n=new tn(e,t);if(mt.push(n),i>0){const r=new hr({color:Zn[i]}),s=new wt().setFromPoints(Io(i,et)),o=new rr(s,r);Jn.push(o)}}const Fo=new hr({color:jp});for(let i=1;i<30;i++){const e=new wt().setFromPoints(No(i,et,mt)),t=new rr(e,Fo);Rn.push(t)}for(let i=0;i<mt.length;i++)Ft.add(mt[i]),i!==9&&Ft.add(Jn[i]);for(let i=1;i<Rn.length;i++)Ft.add(Rn[i]);function Jp(){const i=performance.now(),e=Date.now()/100%1e4,t=e*hn;ms.render(Ft,mi),Ft.remove(gi),gi=new wo(16777215,Co*et,(xi[9]+At[0])*et),gi.position.set(0,0,0),Ft.add(gi);for(let r=1;r<mt.length;r++){const s=t/Wp[r];let o=0,a=new P;if(r!==4?o=At[0]+xi[r]+At[r]:(o=At[3]+xi[r]+At[r],a=mt[3].position),mt[r].position.x=a.x+Math.cos(s*Dt)*o*et,mt[r].position.z=a.z+Math.sin(s*Dt)*o*et,mt[r].position.y=a.y+Math.cos(s*Dt)*Math.sin(Lo[r]*Dt)*o*et,mt[r].scale.set(et,et,et),sr){for(let l=0;l<Jn.length;l++){const c=new hr({color:Zn[l+1]}),h=new wt().setFromPoints(Io(l+1,et)),d=new rr(h,c);Ft.remove(Jn[l]),Jn[l]=d,Ft.add(Jn[l])}sr=!1}for(let l=0;l<Rn.length;l++){const c=new wt().setFromPoints(No(l,et,mt)),h=new rr(c,Fo);Ft.remove(Rn[l]),Rn[l]=h,Ft.add(Rn[l])}mi.lookAt(mt[rt].position),mi.position.x=mt[rt].position.x+At[rt]*et+Zr.x,mi.position.y=mt[rt].position.y+At[rt]*et+Zr.y,mi.position.z=mt[rt].position.z+At[rt]*et+Zr.z}const n=performance.now();$r>1&&(Mi.innerText=Xp,Mi.innerText+=`
### System info ###
